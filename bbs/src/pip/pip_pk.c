...
pip_pk_charm()		/* 魅惑: 耗 hp */
{
  int class;
  char buf[80];
  char name[5][13] = {"凡夫俗子", "色情狂", "小鬼", "龍神", "站長"};
...
pip_pk_summon()		/* 召喚: 耗 mp */
{
  int class;
  char buf[80];
  char name[5][13] = {"史萊姆", "虎頭蜂", "猛虎", "遠古巨龍", "死神撒旦"};
  int injure[5] = {250, 400, 600, 900, 1500};
...
pip_pk_convince()	/* 說服: 耗 vp */
{
  int class;
  char buf[80];
  char name[5][13] = {"面具怪人", "骷髏頭怪", "炸蛋超人", "東海龍王", "齊天大聖"};
  int injure[5] = {250, 400, 600, 900, 1500};
...
pip_pk_incite()		/* 煽動: 耗 sp */
{
  int class;
  char buf[80];
  char name[5][10] = {"巨蠅怪", "布耶魯", "地獄犬", "噴火龍", "熾天使"};
  int injure[5] = {250, 400, 600, 900, 1500};
